...
var RefLoadingButton = function RefLoadingButton(props, ref) {
  ...
  var finalIcon = isString(props.icon) ? {
    type: props.icon
  } : props.icon;

  if (finalIcon) {
    finalIcon = /*#__PURE__*/React.createElement(Icon, finalIcon);
  }
...
export var LoadingButton = React.forwardRef(RefLoadingButton);
export var LoadingButtonManager = function LoadingButtonManager(props) {
  ...
  if (!config || !config.action) {
    return /*#__PURE__*/React.createElement(_Button, restProps);
  }

  var showLoadingAction = function showLoadingAction() {
    return btnRef.current.showLoading();
  };
  ...
  var elem = triggerRenderPlugin(finalCtx, assign({}, config, {
    type: function type() {
      return /*#__PURE__*/React.createElement(LoadingButton, _extends({}, restProps, {
        ref: btnRef
      }));
    },
    action: finalActions
...
export var LoadingLinkManager = function LoadingLinkManager(props) {
  return /*#__PURE__*/React.createElement(LoadingButtonManager, _extends({}, props, {
    type: "link",
