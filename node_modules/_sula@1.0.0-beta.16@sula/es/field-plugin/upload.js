...
var Upload = /*#__PURE__*/function (_React$Component) {
  ...
  function Upload() {
    ...
    _this.onChange = function (e) {
      ...
      var fileList = normalizedFileList(e);
    ...
    _this.customRequest = function (_ref) {
      ...
      var _this$props = _this.props,
          requestConfig = _this$props.request,
          ctx = _this$props.ctx;

      var formDataPrams = _defineProperty({}, filename, file);

      formDataPrams = getFormDataParams(formDataPrams, requestConfig.params);
      var finalRequestConfig = assign({}, requestConfig, {
      ...
      triggerActionPlugin(ctx, finalRequestConfig).then(function (data) {
        onSuccess({
          response: data
        }, file);
      }).catch(onError);
  ...
  _createClass(Upload, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props2, ["request"]);

      return /*#__PURE__*/React.createElement(_Upload, _extends({}, restProps, {
